...
define([
  ...
  return declare("DataviewLoader.widget.DataviewLoader", [_WidgetBase, _TemplatedMixin], {
    ...
    resize: function (box) {
      ...
      if (this.domNode.offsetParent !== null && this._pageInitiated === false) {
    ...
    _updateRendering: function (callback) {
      ...
      if (this._contextObj && this._active) {
    ...
    _loadAndShowcontent: function () {
      ...
      if (this._loadingStarted == false && this._active) {
        ...
        if (this._active == false){
          logger.debug(this.id + "._loadAndShowcontent Skip loading because widget is destroyed.");
        } else if (this._loadingStarted){
          logger.debug(this.id + "._loadAndShowcontent Skip loading because loadingStarted.");
        }
    ...
    _processMicroflowCallback: function (objs) {
      ...
      if (this._active) {
        ...
        logger.debug(this.id + "._processMicroflowCallback Skip loading because widget is destroyed.");
      }
    },
    ...
    _setPage: function (pageObj) {
      ...
      if (this._pageInitiated) {
        ...
        if (pageObj) {
          ...
          pageContext.setContext(pageObj.getEntity(), pageObj.getGuid());
